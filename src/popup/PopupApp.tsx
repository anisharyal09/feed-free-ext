...
export default function PopupApp() {
  ...
  return (
    ...
    >
      ...
      <section>
        <div
          className="rounded-xl flex items-center justify-between border transition-all duration-300"
          style={{
      ...
      >
        <div className="tooltip shrink-0 cursor-help flex items-center" data-tooltip="100% Local & Secure - OpenSource (Check at github.com/anisharyal09/feed-free-ext)">
        ...
        <div className="flex flex-col items-center">
          <a
            href="https://anisharyal09.com.np"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center gap-0.5 hover:text-emerald-400 text-slate-400 transition-colors duration-150 active:scale-95 group"
          >
            <svg className="w-3.5 h-3.5 text-slate-500 group-hover:text-emerald-400 transition-colors" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
            </svg>
            <span className="text-[9px] lowercase tracking-normal font-semibold">anisharyal09</span>
          </a>
        </div>
        <div className="shrink-0">v1.0.0</div>
      </footer>
    </div>
  )
}
